function main() {
  ...
  function generateSquares() {
    ...
    for (let i = 0; i < 10; i += 1) {
      ...
      while (remainder > 0) {
        // Assigning a random number (no larger than ten) to the value rN and subtracting that value
        // from the remainder variable.
        const rN = Math.floor(Math.random() * 5);
        remainder -= rN;
        // Creating an inner block, assigning its class and appending it within the appropriate row
        // div.
